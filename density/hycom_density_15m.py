...
ds_g = {}
for i in list11:
    ds = xr.open_zarr('/projectnb/msldrift/pra-drifters/aws/global_hycom_15m_step_'+str(int(i))+'.zarr')
    ...
    # save the dataset
    countds.to_netcdf('/scratch/tidaldrift/aws/hycom_aws_density_'+str(int(i))+'_15m.nc')
